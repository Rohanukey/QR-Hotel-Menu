            ...
            <div className={Css.SidenavWrapper}>
                ...
                <div className={Css.SideMenu}>
                    <ul>
                        ...
                        <li onClick={() => handleClick('Catogery')} className={`${active === "BalanceSheet" ? Css.active : "" }`}><img width="30" height="30" src="https://img.icons8.com/ios/50/overview-pages-2.png" alt="overview-pages-2"/><span>Food</span></li>
